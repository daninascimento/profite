...
/**
 * @ngdoc function
 * @name profiteApp.controller:MainCtrl
 * @description
 * # MainCtrl
...
angular.module('profiteApp')
    .controller('MainCtrl', function($scope) {
        ...
        $scope.resizeBanner = function($window, element) {
	        var w = angular.element($window);
	        var changeHeight = function() {element.css('height', (w.height() -100) + 'px' );};
				w.bind('resizeBanner', function () {        
			      changeHeight();
			});  
	        changeHeight();
        };
